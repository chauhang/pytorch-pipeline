...
def upload_to_minio(minio_inputs):  #pylint: disable=redefined-outer-name
...
def test_minio_variables_invalid_type(minio_inputs, key):  #pylint: disable=redefined-outer-name
...
def test_minio_mandatory_param(minio_inputs, key):  #pylint: disable=redefined-outer-name
...
def test_missing_access_key(minio_inputs):  #pylint: disable=redefined-outer-name
...
def test_missing_secret_key(minio_inputs):  #pylint: disable=redefined-outer-name
...
def test_unreachable_endpoint(minio_inputs):  #pylint: disable=redefined-outer-name
...
def test_invalid_file_path(minio_inputs):  #pylint: disable=redefined-outer-name
...
def test_minio_upload_file(minio_inputs):  #pylint: disable=redefined-outer-name
...
def test_minio_upload_folder(minio_inputs):  #pylint: disable=redefined-outer-name
